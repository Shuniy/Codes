...
def generateSubarrays(arr):
    ...
    subarrays.sort(key=len)
    return subarrays

def generateSubarrays1(arr):
    subarrays = []
    for i in range(len(arr)):
        for j in range(i + 1):
...
print(generateSubarrays([1,2,3,4,5]))
print(generateSubarrays1([1,2,3,4,5]))
print(generateSubarrays2([1,2,3,4,5]))
