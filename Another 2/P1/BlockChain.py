...
This project is based on the creation of a linked list, though, in this case the list is traversed backwards and has the attribute of inmutability. This has provoked, that some of the methods developed during the course for linked list are not available for the Blockchain list:
