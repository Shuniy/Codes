...
print('Value at position 3 of the linked list',
      doublyLinkedList.getValueAtPosition(3))
print('Value at position 2 of the linked list',
      doublyLinkedList.getValueAtPosition(2))
print('Value at position 1 of the linked list',
      doublyLinkedList.getValueAtPosition(1))
print('Value at position 4 of the linked list',
      doublyLinkedList.getValueAtPosition(4))
